 ...
 * (written for Heimdal Kerberos) will compile, link, and run with SSPI Kerberos
 ...
 *  Nor is there any attempt to make the types identical with Heimdal Kerberos;
 * you can't link this library with object files compiled with the Heimdal
 * Kerberos .h files.
 */
                          ...
                          gss_OID input_name_type, gss_name_t *output_name)
{
  ...
  *minor_status = 0; /* never any minor status */
  if (!gss_default_cred)
  {                              /* default credentials set up yet? */
                               ...
                               OM_uint32 *time_rec)
{
  ...
  *minor_status = 0; /* never any minor status */
  ...
  { /* no, make SSPI buffer from GSSAPI buffer */
  ...
  *minor_status = 0; /* never any minor status */
  ...
  case GSS_C_GSS_CODE: /* major_status */
    ...
    case GSS_S_CREDENTIALS_EXPIRED:
      s = "Credentials expired";
      break;
    case GSS_S_BAD_BINDINGS:
      s = "Bad bindings";
      break;
    case GSS_S_BAD_MECH:
      s = "Bad mechanism type";
      break;
    case GSS_S_BAD_NAME:
      s = "Bad name";
      break;
    ...
    case SEC_E_NO_AUTHENTICATING_AUTHORITY:
      s = "No authenticating authority";
      break;
    case SEC_E_TARGET_UNKNOWN:
      s = "Destination server unknown to Kerberos service";
      break;
    default:
                                 ...
                                 gss_buffer_t output_token)
{
  ...
  *minor_status = 0; /* never any minor status */
  ...
  major_status = output_token ? GSS_S_FAILURE : DeleteSecurityContext(*context_handle);
  ...
  *conf_state = conf_req_flag; /* same as requested */
      ...
      SEC_E_OK)
  {
        ...
        GSS_S_COMPLETE)
    {
      ...
      fs_give(&output_message_buffer->value);
  }
